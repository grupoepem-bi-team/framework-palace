# Palace Framework — Scripts de Desinstalación

Este directorio contiene los scripts necesarios para desinstalar completamente el Palace Framework de tu sistema Windows.
...
```
Elimina:
- La ruta del entorno virtual del PATH del usuario
- Acceso global al comando `palace`

#### Limpiar proyecto específico (versión interactiva)
```cmd
limpiar-proyecto.bat
```
Elimina de un proyecto:
- Carpeta `ai_context/`
- Archivo `.palace.env`
- Registro del proyecto en el framework
...
- Los archivos de contexto `ai_context/` en tus proyectos (si usás `limpiar-proyecto.bat`)
